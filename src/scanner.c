...
// for unbranching paths in the tree
static TokenType checkKeyword(Scanner *scanner, int start,
                              int length,
                              const char *rest,
                              TokenType type) {
...
static Token identify(Scanner *scanner) {
...
Token scanToken(Scanner *scanner) {
    ...
    if (isAlpha(c)) return identify(scanner);
